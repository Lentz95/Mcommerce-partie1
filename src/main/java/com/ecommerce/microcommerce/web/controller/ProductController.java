...
public class ProductController {
    ...
    public ResponseEntity<Void> ajouterProduit(@Valid @RequestBody Product product,BindingResult bindingResult) {
    	...
    	if(bindingResult.hasErrors() && bindingResult.getRawFieldValue("prix").equals(0)) 
    		 throw new ProduitGratuitException("le prix doit etre superieur a 0"); 
 ...
 @GetMapping(value = "/productsByOrder")
